...
import TopBarTitle from './components/TopBarTitle/index.js'
import Hamburger from './components/Hamburger/index.js'
import Nav from './components/Nav/index.js'
import MainList from './components/MainList/index.js'
import MegaList from './components/MegaList/index.js'
import MainNavItem from './components/MainNavItem/index.js'
import MainNavItemLink from './components/MainNavItemLink/index.js'
...
import NavItemDescription from './components/NavItemDescription/index.js'

// State Machines
import { MenuStateMachine } from './state-machines/menus.js'
...
YK_Menu.defaultProps = { logoImage: null }
YK_Menu.propTypes = {
    logoImage: PropTypes.string,
}
export default React.memo(YK_Menu);
// export default YK_Menu
